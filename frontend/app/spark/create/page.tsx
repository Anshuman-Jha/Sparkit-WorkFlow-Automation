...
export default function Create() {
    ...
    return (
        <div>
            ...
            {
                selectedModalIndex && <Modal index={selectedModalIndex} availableItems={selectedModalIndex == 1 ? availableTriggers : availableActions} onSelect={(props: null | { name: string, id: string }) => {
                    if (props == null) {
